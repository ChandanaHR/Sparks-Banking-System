...
if(isset($_POST['submit']))
{
    ...
    // To check whether the entered amount is negative value
    if (($amount)<0)
   {
        echo '<script type="text/javascript">';
        echo ' alert("Oops! Amount cant be negative")';  // showing an alert box.
        echo '</script>';
    }


  
    // To check whether there is insufficient balance
    ...
    // To check whether the entered amount is zero value
    else if($amount == 0){
